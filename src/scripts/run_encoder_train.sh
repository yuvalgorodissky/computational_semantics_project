...
#SBATCH --output /sise/eliorsu-group/yuvalgor/courses/computational_semantics_project/jobs_out/encoder_job-%J-$x.out			### output log for running job - %J for job number
...
python "$base_path/src/run_squad.py" \
  --model_type bert \
  --model_name_or_path "$model_path" \
  --do_train \
  --do_eval \
  --do_lower_case \
  --train_file "/sise/eliorsu-group/yuvalgor/courses/computational_semantics_project/datasets/squad_data/$dataset.json" \
  --predict_file "/sise/eliorsu-group/yuvalgor/courses/computational_semantics_project/datasets/squad_data/valid.json" \
